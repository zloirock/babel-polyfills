...
import _Iterator$zip from "core-js-pure/stable/iterator/zip.js";
import _Iterator$zipKeyed from "core-js-pure/stable/iterator/zip-keyed.js";
...
a.clamp(b, c);
_Promise.allKeyed(a);
_Promise.allSettledKeyed(a);
_includesInstanceProperty(a).call(a);
a.join();
